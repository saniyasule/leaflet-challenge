...
d3.json(queryUrl, function(data) {
    ...
    var platesStyle = {
      ...
      legend.onAdd = function() {
        ...
        var labelsTextHtml = "<ul>" + labelsText.join("<br>") + "</ul>";
        var legendInfo = "<h4>Earthquake</h4>" +
          "<div class=\"labels\">" + labelsColorHtml + "<h4>Magnitude</h4>" + 
          "</div>" + "<div class=\"labels\">" + labelsTextHtml
          "</div>";
